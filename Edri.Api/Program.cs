...
using Edri.Api.BackgroundServices;
using Edri.Api.Extensions;
using Edri.Application.Extensions;
using Edri.Application.gRPC;
using Edri.Domain.Consumers;
using Edri.Domain.Extensions;
using Edri.Infrastructure.Database;
using Edri.Infrastructure.Extensions;
using Edri.ServiceDefaults;
...
builder.Services
    ...
    .AddNpgSql(dbConnectionString!) // <--- CAMBIO AQUÍ: Antes era AddSqlServer
...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
{
    ...
    options.UseNpgsql(dbConnectionString,
        b => b.MigrationsAssembly("Edri.Infrastructure"));
});

builder.Services.AddSwagger();
builder.Services.AddAuth(builder.Configuration);
builder.Services.AddInfrastructure("Edri.Infrastructure", dbConnectionString!);
