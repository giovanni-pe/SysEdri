...
namespace Edri.IntegrationTests.Infrastructure;

public sealed class EdriWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public EdriWebApplicationFactory(
